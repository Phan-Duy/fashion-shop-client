	...
	return (
		<div className='container my-5 bg-super-light p-4 rounded'>
			...
			<p>
				...
				khuyết, hư hỏng hoặc không như mô tả, DSHOP cam kết bảo vệ khách
			...
			<p>
				...
				<a href='#!chinh-sach-doi-tra-hang'>
					<strong>DSHOP.com/chinh-sach-doi-tra-hang</strong>
				</a>{" "}
			...
			<ul>
				<li>
					<p>Quý khách vui lòng thông báo về cho DSHOP ngay khi:</p>
					<p>
						{" "}
				...
				<li>
					<p>
						Sau khi DSHOP xác nhận mail tiếp nhận yêu cầu kiểm tra xử
						lý, DSHOP sẽ liên hệ đến quý khách để xác nhận thông tin
						hoặc nhờ bổ sung thông tin (nếu có). Trường hợp không liên hệ
						được DSHOP rất tiếc xin được phép từ chối xử lý yêu cầu.
						Thời gian DSHOP liên hệ trong giờ hành chính tối đa 3 lần
			...
			<p>
				...
				<strong>DSHOP</strong> trong vòng 30 ngày kể từ khi nhận hàng với
			...
			<br />
			<p>
				<strong>DSHOP</strong> hỗ trợ đổi/ trả sản phẩm cho quý khách nếu:
			</p>
			<ul>
				<li>
			...
			<ul>
				<li>
					<p>
						...
						<strong>cskh@DSHOP.com.vn</strong> với tiêu đề{" "}
			...
			<ul>
				<li>
					Để đảm bảo quyền lợi khách hàng và để <strong>DSHOP</strong> có
					...
					clip từ quý khách, <strong>DSHOP</strong> xin phép từ chối hỗ
					trợ.
				</li>
			</ul>
			<table
			...
			>
				<tbody>
					...
					<tr>
						...
						<td>
							<p>DSHOP có sản phẩm→ đổi mới cùng sản phẩm</p>
							<p>
								DSHOP hết hàng→ Hoàn tiền hoặc quý khách có thể chọn
					...
					<tr>
						...
						<td>
							...
							<p>
								**Lưu ý: DSHOP rất tiếc sẽ không hỗ trợ hoàn lại chi
